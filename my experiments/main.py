...
for s in range(model_num):
    ...
    PATH = './data/results/resnet18_cifar10_model_size_%d_%f_%d.pth' % (model_num ,lr, seed_number)
    torch.save(model.state_dict(), PATH)

# model_nums = 3, accuracy = 96.31%
# model_nums = 5, accuracy = 96.13%
# model_nums = 10, accuracy = 96.45%
